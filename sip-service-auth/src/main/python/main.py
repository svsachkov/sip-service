...
# x = requests.get(url)
#
# with open('src/main/python/img4.jpg', 'wb') as f:
#     f.write(x.content)
...
headers = {
      ...
      # "Content-Length": 129,
      # "User-Agent": "PostmanRuntime/7.31.3 Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.52 Safari/536.5",
      "Content-Type": "application/json",
      "accept": "application/json",
      # "Accept": "*/*",
      # "Accept-Encoding": "gzip,deflate,sdch,br",
      # "Cookie": "JSESSIONID=E8EAD69F7DA05C0983E46021993A1073"
}
url = "https://localhost:8000/register"
x = requests.post(url, headers=headers, json=user)
